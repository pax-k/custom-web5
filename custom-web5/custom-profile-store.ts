...
import { ProfileIndex } from './custom-profile-index';
import { Profile } from './extracted-types';
...
export class CustomProfileStore implements QueryStore<Profile> {
  ...
  constructor(options: ProfileStoreOptions = {}) {
    options = { ...CustomProfileStore._defaultOptions, ...options };
